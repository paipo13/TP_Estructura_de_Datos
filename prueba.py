...
# #GRAFICO DE BARRA usando matplotlib
# #Supongamos que quieres mostrar la cantidad de teléfonos por sistema operativo.
...
# telefono1 = [1, "iPhone", "12 Pro", "iOS", "14.5", 6, 128, 1234567890]
# telefono2 = [2, "Samsung", "Galaxy S21", "Android", "11", 8, 256, 9876543210]
# telefono3 = [3, "Google", "Pixel 5", "Android", "12", 8, 128, 5555555555]
# telefono4 = [4, "Xiaomi", "Mi 11", "Android", "11", 8, 256, 1112223333]
# #Como hacer para agregar datos a un diccionario si ya estan presentes?
...
# agregar_datos_diccionario(diccionario_prueba, telefono1[3])
# agregar_datos_diccionario(diccionario_prueba, telefono2[3])
# agregar_datos_diccionario(diccionario_prueba, telefono3[3])
# agregar_datos_diccionario(diccionario_prueba, telefono4[3])

# print(diccionario_prueba)
# grafico_barras(diccionario_prueba)
